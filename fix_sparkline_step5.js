          ...
          <ng-container *ngIf="sidePanelApp === 'sparkline' && sparklineConfig">
            <div style="display:flex; flex-direction:column; gap:16px;">
              <div style="display:flex; justify-content:space-between; align-items:center;">
                 ...
                 <button (click)="closeApp()" style="background:none; border:none; cursor:pointer;"><span class="material-symbols-outlined" style="font-size:18px; color:#5f6368;">close</span></button>
              </div>
...
console.log('Done Sparkline settings panel HTML!');
