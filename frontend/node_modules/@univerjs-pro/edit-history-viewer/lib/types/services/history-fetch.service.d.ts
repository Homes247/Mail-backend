...
export declare class HistoryFetchService extends Disposable {
    ...
    constructor(_snapshotServerService: ISnapshotServerService, _univerInstanceService: IUniverInstanceService, _commandService: ICommandService, _configService: IConfigService, _httpService: HTTPService, _compressMutationService: CompressMutationService);
    dispose(): void;
