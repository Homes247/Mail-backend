...
export declare const hsvToHsl: (h: number, s: number, v: number) => [number, number, number];
export declare const hslToHsv: (h: number, s: number, l: number) => [number, number, number];
