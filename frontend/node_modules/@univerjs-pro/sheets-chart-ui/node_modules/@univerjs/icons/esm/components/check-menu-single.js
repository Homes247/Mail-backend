...
export var CheckMenuSingle = forwardRef(function (props, ref) {
    return createElement(IconBase, Object.assign({}, props, {
        id: 'check-menu-single',
        ref: ref,
        icon: element,
    }));
});
CheckMenuSingle.displayName = 'CheckMenuSingle';
export default CheckMenuSingle;
//# sourceMappingURL=check-menu-single.js.map