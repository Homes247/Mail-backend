...
import { Disposable, DrawingTypeEnum, ICommandService, IContextService, Injector, IUniverInstanceService } from '@univerjs/core';
...
export declare class SheetsChartUIController extends Disposable {
    ...
    constructor(_drawingManagerService: IDrawingManagerService, _univerInstanceService: IUniverInstanceService, _injector: Injector, _chartModelService: ChartModelService, _sidebarService: ISidebarService, _componentManager: ComponentManager, _menuManagerService: IMenuManagerService, _sheetInterceptorService: SheetInterceptorService, _sheetCanvasPopManagerService: SheetCanvasPopManagerService, _commandService: ICommandService, _sheetsChartUIService: SheetsChartUIService, _contextService: IContextService);
