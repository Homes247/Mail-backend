import { IObjectMatrixPrimitiveType, IRange, ObjectMatrix } from '@univerjs/core';
...
export interface ISparklineDataSource {
}
/**
...
export interface ISparklineItem {
    source: string;
    position: ISparklinePosition;
}
