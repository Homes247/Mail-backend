...
export var AlignTextTopSingle = forwardRef(function (props, ref) {
    return createElement(IconBase, Object.assign({}, props, {
        id: 'align-text-top-single',
        ref: ref,
        icon: element,
    }));
});
AlignTextTopSingle.displayName = 'AlignTextTopSingle';
export default AlignTextTopSingle;
//# sourceMappingURL=align-text-top-single.js.map