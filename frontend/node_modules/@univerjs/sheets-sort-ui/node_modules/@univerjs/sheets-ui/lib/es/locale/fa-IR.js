const e = {
  ...
  toolbar: {
    ...
    currencyFormat: "قالب‌بندی به عنوان ارز",
    percentageFormat: "قالب‌بندی به عنوان درصد",
    ...
    resetColor: "بازنشانی",
    customColor: "سفارشی",
    alternatingColors: "رنگ‌های متناوب",
    confirmColor: "تایید",
    cancelColor: "انصراف",
    collapse: "جمع کردن",
    fillColor: {
    ...
    sortAndFilter: "مرتب‌سازی و فیلتر",
    findAndReplace: "یافتن و جایگزینی",
    sum: "SUM",
    autoSum: "جمع خودکار",
    moreFunction: "توابع بیشتر",
    conditionalFormatting: "قالب‌بندی شرطی",
    comment: "نظر",
  ...
  defaultFmt: {
    ...
    Digit: {
      text: "ده‌ها هزار با دو رقم اعشار",
      value: "w0.00",
      example: "2万2500.55"
    },
    Date: {
    ...
    CustomFormats: { text: "قالب‌های سفارشی", value: "fmtOtherSelf", example: "" }
  },
  format: {
    moreCurrency: "قالب‌های ارز بیشتر",
    moreDateTime: "قالب‌های تاریخ و زمان بیشتر",
    moreNumber: "قالب‌های عددی بیشتر",
    titleCurrency: "قالب‌های ارز",
    decimalPlaces: "اعشار",
    titleDateTime: "قالب‌های تاریخ و زمان",
    titleNumber: "قالب‌های عددی"
  },
  print: {
    normalBtn: "عادی",
    layoutBtn: "چیدمان صفحه",
    pageBtn: "پیش‌نمایش شکست صفحه",
    menuItemPrint: "چاپ (Ctrl+P)",
    menuItemAreas: "مناطق چاپ",
    menuItemRows: "سطرهای عنوان چاپ",
    menuItemColumns: "ستون‌های عنوان چاپ"
  },
  align: {
    left: "چپ",
    center: "وسط",
  ...
  rightClick: {
    ...
    counterclockwise: "در خلاف جهت عقربه‌های ساعت",
    transpose: "ترانهاده",
