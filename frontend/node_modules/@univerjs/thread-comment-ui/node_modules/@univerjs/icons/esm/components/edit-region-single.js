...
export var EditRegionSingle = forwardRef(function (props, ref) {
    return createElement(IconBase, Object.assign({}, props, {
        id: 'edit-region-single',
        ref: ref,
        icon: element,
    }));
});
EditRegionSingle.displayName = 'EditRegionSingle';
export default EditRegionSingle;
//# sourceMappingURL=edit-region-single.js.map