...
export var PasteColumnWidthOnly = forwardRef(function (props, ref) {
    return createElement(IconBase, Object.assign({}, props, {
        id: 'paste-column-width-only',
        ref: ref,
        icon: element,
    }));
});
PasteColumnWidthOnly.displayName = 'PasteColumnWidthOnly';
export default PasteColumnWidthOnly;
//# sourceMappingURL=paste-column-width-only.js.map