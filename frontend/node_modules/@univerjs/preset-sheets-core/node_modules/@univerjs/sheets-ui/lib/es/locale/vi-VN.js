const n = {
  ...
  toolbar: {
    ...
    percentageFormat: "Định dạng phần trăm",
    numberDecrease: "Giảm số thập phân",
    numberIncrease: "Tăng số thập phân",
    moreFormats: "Thêm định dạng",
    font: "Phông chữ",
    fontSize: "Cỡ chữ",
    bold: "In đậm",
    italic: "In nghiêng",
    ...
    customColor: "Tùy chỉnh màu",
    alternatingColors: "Màu xen kẽ",
  ...
  defaultFmt: {
    ...
    Digit: {
      text: "Ngàn với 2 số thập phân",
      value: "w0.00",
      example: "2 triệu 2500.55"
    },
    Date: {
      text: "Ngày",
      value: "yyyy-MM-dd",
    ...
    Time: { text: "Thời gian", value: "hh:mm AM/PM", example: "3:00 PM" },
    Time24H: { text: "Thời gian 24H", value: "hh:mm", example: "15:00" },
    DateTime: { text: "Ngày giờ", value: "yyyy-MM-dd hh:mm AM/PM", example: "2017-11-29 3:00 PM" },
    DateTime24H: { text: "Ngày giờ 24H", value: "yyyy-MM-dd hh:mm", example: "2017-11-29 15:00" },
    CustomFormats: { text: "Định dạng tùy chỉnh", value: "fmtOtherSelf", example: "" }
  },
  format: {
    moreCurrency: "Thêm định dạng tiền tệ",
    moreDateTime: "Thêm định dạng ngày giờ",
    moreNumber: "Thêm định dạng số",
    titleCurrency: "Định dạng tiền tệ",
    decimalPlaces: "Số thập phân",
    titleDateTime: "Định dạng ngày giờ",
    titleNumber: "Định dạng số"
  },
  print: {
    normalBtn: "Chế độ xem thường",
    layoutBtn: "Bố cục trang",
    pageBtn: "Xem trước trang",
    menuItemPrint: "In (Ctrl+P)",
    menuItemAreas: "Vùng in",
    menuItemRows: "Hàng tiêu đề",
    menuItemColumns: "Cột tiêu đề"
  },
  align: {
    left: "Căn trái",
    center: "Căn giữa",
  ...
  rightClick: {
    ...
    clearAll: "Xóa tất cả",
    matrix: "Ma trận thao tác vùng chọn",
    sortSelection: "Sắp xếp vùng chọn",
    filterSelection: "Lọc vùng chọn",
    chartGeneration: "Tạo biểu đồ",
    firstLineTitle: "Dòng đầu tiên làm tiêu đề",
    untitled: "Không tiêu đề",
    array1: "Mảng một chiều",
    array2: "Mảng hai chiều",
    array3: "Mảng đa chiều",
    diagonal: "Đường chéo",
    antiDiagonal: "Đường chéo ngược",
    diagonalOffset: "Độ lệch đường chéo",
    offset: "Độ lệch",
    boolean: "Giá trị Boolean",
    flip: "Lật",
    upAndDown: "Lên và xuống",
    leftAndRight: "Trái và phải",
    clockwise: "Theo chiều kim đồng hồ",
    counterclockwise: "Ngược chiều kim đồng hồ",
    transpose: "Chuyển vị",
    matrixCalculation: "Tính toán ma trận",
    plus: "Cộng",
    minus: "Trừ",
    multiply: "Nhân",
    divided: "Chia",
