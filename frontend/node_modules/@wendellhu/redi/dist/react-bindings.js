(function (global, factory) {
        ...
        return (React__namespace.createElement(RediConsumer, null, function (context) {
            ...
            if (childInjectorRef.current) {
                ...
                childInjector = context.injector
                    ...
                    : new redi.Injector(dependencies);
                childInjectorRef.current = childInjector;
            }
            return (React__namespace.createElement(RediProvider, { value: { injector: childInjector } }, children));
        }));
    }
    /**
     * @param Comp
    ...
    function connectInjector(Comp, injector) {
        return function ComponentWithInjector(props) {
            return (React__namespace.createElement(RediProvider, { value: { injector: injector } },
                React__namespace.createElement(Comp, __assign({}, props))));
        };
    }
    function connectDependencies(Comp, dependencies) {
        return function ComponentWithInjector(props) {
            return (React__namespace.createElement(RediInjector, { dependencies: dependencies },
                React__namespace.createElement(Comp, __assign({}, props))));
        };
    }
        ...
        return function () {
            return {
                get: function () {
                    ...
                    var thing = injector.get(id, quantity || redi.Quantity.REQUIRED, lookUp);
                    return thing;
                },
            };
        };
